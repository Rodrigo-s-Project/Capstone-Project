...
import { createFolder, getDocumentsFromBucket } from "../controllers/drive/documents/index";

// Protected route
router.get("/get-buckets/:companyId/:teamId", authenticate, getBucketsFromTeam);
router.get("/get-documents/:teamId/:bucketId", authenticate, getDocumentsFromBucket);
